...
<style>
  ...
  .record-meta {
    ...
    padding: 8px 14px; border-radius: var(--radius-md); margin-top: 10px;
    background: var(--surface); border: 1px solid var(--border);
    font-size: 12px; font-weight: 600; color: var(--text-secondary);
  }
  .record-meta .meta-label { color: var(--text-dim); font-weight: 500; }
  ...
  .form-card-icon  { width:40px; height:40px; border-radius:var(--radius-md); display:grid; place-items:center; font-size:18px; background: rgba(245,158,11,0.12); flex-shrink:0; }
  ...
  .form-section-title::before { content:''; width:3px; height:14px; background:var(--solar-amber); border-radius:2px; }

  .form-grid-2 { display:grid; grid-template-columns:1fr 1fr; gap:18px; }

  .form-field { display:flex; flex-direction:column; gap:6px; }
  .form-field label { font-size:12px; font-weight:600; color:var(--text-secondary); letter-spacing:0.02em; }
  ...
  .form-field select:focus { border-color:var(--solar-amber); background:var(--midnight); box-shadow:0 0 0 3px rgba(245,158,11,0.12); }
  ...
  .select-wrap::after { content:'▾'; position:absolute; right:14px; top:50%; transform:translateY(-50%); font-size:12px; color:var(--text-dim); pointer-events:none; }
  ...
  .weather-opt:checked + .weather-opt-label { border-color:var(--solar-amber); background:rgba(245,158,11,0.08); box-shadow:0 0 0 3px rgba(245,158,11,0.1); }
  .weather-emoji   { font-size:24px; line-height:1; }
  .weather-lbl-text { font-size:11px; font-weight:600; color:var(--text-secondary); }

  .danger-zone {
    margin-top: 24px; padding: 18px 22px; border-radius: var(--radius-md);
    border: 1.5px solid var(--danger-border); background: var(--danger-bg);
    display: flex; align-items: center; justify-content: space-between; gap: 16px;
  }
  .danger-zone-text .dz-title { font-size:13px; font-weight:700; color:var(--danger); margin-bottom:2px; }
  .danger-zone-text .dz-sub   { font-size:11px; color:var(--text-muted); }
  .btn-delete {
